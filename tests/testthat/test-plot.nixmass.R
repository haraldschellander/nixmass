test_that("plot.nixmass validates input correctly", {
        ...
        expect_error(plot.nixmass(invalid_object), 
        ...
        expect_error(plot.nixmass(valid_object_no_model), 
        ...
        expect_error(plot.nixmass(valid_object_missing_layers, density = TRUE), 
