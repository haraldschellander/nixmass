swe.delta.snow.rho.max <- function(data, 
                                   sigma = 0.02986102,
                                   mu = 148.3291,
                                   rho_h = 588.6178,
                                   rho_l = 369.0934,
     ...
     # dynamic rho.null
     #-------------------------------------------------------------------------
     rho.null.dyn <- function(slope, int, delta_h){
          int + slope * delta_h
     }
     ...
     rho_max_dyn <- function(t){
             ...
             atan(sigma*(t-mu)) * (rho_h-rho_l)/pi + (rho_h+rho_l)/2
     ...
     if(verbose){
          cat("Using parameters:\n",
              #"rho.max  = ",rho.max,"\n",
              #"rho.max.int = ",rho.max.int,"\n",
              #"rho.max.slope = ",rho.max.slope,"\n",
              "c.ov     = ",c.ov,"\n",
              "k.ov     = ",k.ov,"\n",
              "k        = ",k,"\n",
              "tau      = ",tau,"\n",
