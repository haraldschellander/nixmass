swe.delta.snow.rho.null <- function(data,  
                           #rho.null = 81.19417, 
                           #rho.null.slope = 1000, rho.null.int = 20, 
                           sigma_rho_null = 3.99999,
                           mu_rho_null = 0.500204,
                           rho_null_h = 199.8854,
                           rho_null_l = 49.9991,
                           rho.max = 394.1982,
                           c.ov = 0.0004056099, k.ov = 0.7315858, 
                           k = 0.02677043, tau = 0.02022883, eta.null = 10921657,
        ...
        rho_null_dyn <- function(dh){
                atan(sigma_rho_null * (dh - mu_rho_null)) * (rho_null_h - rho_null_l)/pi + (rho_null_h + rho_null_l)/2
        }
        ...
        if(verbose){
                cat("Using parameters:\n",
                    "rho.max  = ",rho.max,"\n",
                    "rho.null.int = ",rho.null.int,"\n",
                    "rho.null.slope = ",rho.null.slope,"\n",
                    "c.ov     = ",c.ov,"\n",
                    "k.ov     = ",k.ov,"\n",
                    "k        = ",k,"\n",
                    "tau      = ",tau,"\n",
